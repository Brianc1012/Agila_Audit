...
router.use(roleAccess_middleware_1.requireSuperAdmin);
...
router.delete('/audit-logs/:id', rateLimit_middleware_1.writeRateLimiter, (0, errorHandler_middleware_1.asyncHandler)(auditLogs_controller_1.deleteAuditLogHandler));
